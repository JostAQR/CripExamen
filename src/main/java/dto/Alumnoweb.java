...
public class Alumnoweb implements Serializable {
    ...
    @Column(name = "codiEstdWebcodiEstdWeb")
    private Integer codiEstdWebcodiEstdWeb;
    @Basic(optional = false)
    @NotNull
    @Size(min = 1, max = 50)
    ...
    public Alumnoweb(Integer codiEstdWebcodiEstdWeb) {
        this.codiEstdWebcodiEstdWeb = codiEstdWebcodiEstdWeb;
    }

    public Alumnoweb(Integer codiEstdWebcodiEstdWeb, String ndniEstdWeb, String appaEstdWeb, String apmaEstdWeb, String nombEstdWeb, Date fechNaciEstdWeb, String logiEstd, String passEstd) {
        this.codiEstdWebcodiEstdWeb = codiEstdWebcodiEstdWeb;
    ...
    public Integer getCodiEstdWebcodiEstdWeb() {
        return codiEstdWebcodiEstdWeb;
    }

    public void setCodiEstdWebcodiEstdWeb(Integer codiEstdWebcodiEstdWeb) {
        this.codiEstdWebcodiEstdWeb = codiEstdWebcodiEstdWeb;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (codiEstdWebcodiEstdWeb != null ? codiEstdWebcodiEstdWeb.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if ((this.codiEstdWebcodiEstdWeb == null && other.codiEstdWebcodiEstdWeb != null) || (this.codiEstdWebcodiEstdWeb != null && !this.codiEstdWebcodiEstdWeb.equals(other.codiEstdWebcodiEstdWeb))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "dto.Alumnoweb[ codiEstdWebcodiEstdWeb=" + codiEstdWebcodiEstdWeb + " ]";
    }
